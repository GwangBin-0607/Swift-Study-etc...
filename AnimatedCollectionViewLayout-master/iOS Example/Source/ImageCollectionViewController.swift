...
class ImageCollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        self.collectionView.register(SecondCollectionViewCell.self, forCellWithReuseIdentifier: "SecondCollectionViewCellPage")
...
extension ImageCollectionViewController: UICollectionViewDelegateFlowLayout {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let c = collectionView.dequeueReusableCell(withReuseIdentifier: "SecondCollectionViewCellPage", for: indexPath)
        //let c = collectionView.dequeueReusableCell(withReuseIdentifier: cellIdentifier, for: indexPath)
        if let cell = c as? SecondCollectionViewCell {
